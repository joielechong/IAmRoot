 ...
 * Disclaimer: **root==Übermensch**, so there's no 100% way to check for root.
 */
public class IAmRoot {

    private final Context mContext;
    private boolean loggingEnabled = true;

    public IAmRoot(Context context) {
        mContext = context;
    }
    ...
    public boolean canLoadNativeLibrary(){
        return new IAmRootNative().wasNativeLibraryLoaded();
    }
    ...
    public boolean checkForRootNative() {
        ...
        IAmRootNative IAmRootNative = new IAmRootNative();
        IAmRootNative.setLogDebugMessages(loggingEnabled);
        return IAmRootNative.checkForRoot(paths) > 0;
    }
